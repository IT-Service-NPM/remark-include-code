...
[Home](./index.md) &gt; [@it-service-npm/remark-include-code](./remark-include-code.md) &gt; [remarkIncludeCode](./remark-include-code.remarkincludecode.md)

## remarkIncludeCode variable
